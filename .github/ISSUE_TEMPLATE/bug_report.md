...
OpenNTX V0.2 does not execute Windows applications. Do not report "app does not run" as a runtime bug unless the issue is about documented dry-run behavior, analysis, schemas, docs, or planning output.
