...
- Not a Lutris clone.
- Not a VM manager.
- Not a complete Windows runtime in V0.1.
...
OpenNTX V0.1 is an experimental foundation and design prototype.
...
AppPortal is the user-facing install surface. V0.1 ships as a lightweight TUI/mock that documents the intended flow without adding heavy GUI dependencies.
...
V0.1 commands produce validation and planning output. They do not execute Windows binaries.
...
- Phase 1: real PE analyzer and manifest generator.
