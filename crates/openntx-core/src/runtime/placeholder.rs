...
impl RuntimeBackend for NotImplementedBackend {
    ...
    fn plan_execution(&self, manifest: &AppManifest) -> RuntimeExecutionPlan {
        RuntimeExecutionPlan {
            ...
            implemented: false,
            message: "Runtime execution is not implemented. This command currently validates input and prepares a future execution plan.".to_string(),
        }
    }
...
impl RuntimeBackend for FutureNativeBackend {
    ...
    fn plan_execution(&self, manifest: &AppManifest) -> RuntimeExecutionPlan {
        RuntimeExecutionPlan {
            ...
            implemented: false,
            message:
                "Future native PE/NT/Win32 backend is a research module, not V0.5 functionality."
                    .to_string(),
        }
    }
