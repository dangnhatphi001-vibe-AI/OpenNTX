...
V0.6 can generate an initial manifest from PE metadata before capture. It still does not execute installers or perform real filesystem/registry diff capture.
